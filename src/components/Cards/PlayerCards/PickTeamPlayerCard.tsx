...
type PickTeamPlayerCard = {
    player: FantasyPlayer | null;
    position: string
}

export const PickTeamPlayerCard = ({ player, position }: PickTeamPlayerCard) => {
    ...
    const actionBtn: JSX.Element = (
        <>
            ...
            {player && <button type="button" className="btn flex bg-yellow-400 w-full p-1 " onClick={() => dispatch(pickTeamRemovePlayer(player))}>
